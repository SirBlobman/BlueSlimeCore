...
public abstract class FactionsHandler {
     ...
     * @return {@code true} if player2 is the same as player1.
     * {@code false} if either player is not in a faction.
     * {@code true} if player2 has an ally relationship with player1.
     * {@code true} if player2 is in the same faction as player1.
     ...
     * @param player1 The first player
     * @param player2 The second player
     * @return {@code false} if player2 is the same as player1.
     * {@code false} if either player is not in a faction.
     * {@code true} if player2 has an enemy relationship with player1.
     * {@code false} otherwise
     */
