...
public interface CustomNbtContainer {
     ...
     */
    @Nullable
    <T, Z> Z get(@NotNull String key, @NotNull CustomNbtType<T, Z> type);
     ...
     */
    @NotNull
    <T, Z> Z getOrDefault(@NotNull String key, @NotNull CustomNbtType<T, Z> type, @NotNull Z defaultValue);
