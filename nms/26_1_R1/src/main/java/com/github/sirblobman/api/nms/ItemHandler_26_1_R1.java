...
public final class ItemHandler_26_1_R1 extends ItemHandler {
    public ItemHandler_26_1_R1(@NotNull JavaPlugin plugin) {
        super(plugin);
    }
    ...
    public @NotNull String toNBT(@NotNull ItemStack item) {
        ...
        ProblemReporter problemReporter = new ProblemReporter_26_1_R1(plugin);
