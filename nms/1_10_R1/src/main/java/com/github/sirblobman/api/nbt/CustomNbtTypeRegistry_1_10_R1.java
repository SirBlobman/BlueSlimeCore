...
public final class CustomNbtTypeRegistry_1_10_R1 {
    ...
    private <T> CustomNbtTagAdapter_1_10_R1<?, ?> createAdapter(Class<T> type) {
        ...
        if (Objects.equals(Byte.class, type)) {
            ...
            return this.createAdapter(Double.class, NBTTagDouble.class, NBTTagDouble::new, NBTTagDouble::h);
            ...
            return createAdapter(CustomNbtContainer_1_10_R1.class, NBTTagCompound.class,
                    CustomNbtContainer_1_10_R1::toTagCompound, this::tagToContainer);
        } else {
    ...
    private CustomNbtContainer_1_10_R1 tagToContainer(NBTTagCompound tag) {
        CustomNbtContainer_1_10_R1 container = new CustomNbtContainer_1_10_R1(this);
    ...
    private <T, Z extends NBTBase> CustomNbtTagAdapter_1_10_R1<T, Z> createAdapter(Class<T> primitiveType,
                                                                                   Class<Z> nbtBaseType,
                                                                                   Function<T, Z> builder,
                                                                                   Function<Z, T> extractor) {
        return new CustomNbtTagAdapter_1_10_R1<>(primitiveType, nbtBaseType, builder, extractor);
    }
    ...
    public <T> T extract(Class<T> type, NBTBase tag) throws ClassCastException, IllegalArgumentException {
        CustomNbtTagAdapter_1_10_R1<?, ?> adapter = this.adapters.computeIfAbsent(type, this.CREATE_ADAPTER);
