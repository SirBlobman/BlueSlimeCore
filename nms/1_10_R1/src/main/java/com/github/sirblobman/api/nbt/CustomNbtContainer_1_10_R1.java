...
public final class CustomNbtContainer_1_10_R1 implements CustomNbtContainer {
    private final Map<String, NBTBase> customDataTags;
    private final CustomNbtTypeRegistry_1_10_R1 registry;
    private final CustomNbtContext_1_10_R1 adapterContext;

    public CustomNbtContainer_1_10_R1(Map<String, NBTBase> customTags, CustomNbtTypeRegistry_1_10_R1 registry) {
        this(registry);
        this.customDataTags.putAll(customTags);
    }

    public CustomNbtContainer_1_10_R1(CustomNbtTypeRegistry_1_10_R1 registry) {
        this.customDataTags = new HashMap<>();
        this.registry = registry;
        this.adapterContext = new CustomNbtContext_1_10_R1(this.registry);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CustomNbtContainer_1_10_R1)) {
            return false;
        } else {
            Map<String, NBTBase> myRawMap = this.getRaw();
            Map<String, NBTBase> theirRawMap = ((CustomNbtContainer_1_10_R1) obj).getRaw();
    ...
    public CustomNbtTypeRegistry_1_10_R1 getDataTagTypeRegistry() {
