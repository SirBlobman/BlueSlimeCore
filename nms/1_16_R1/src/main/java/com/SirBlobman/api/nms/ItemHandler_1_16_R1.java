...
public class ItemHandler_1_16_R1 extends ItemHandler {
    public ItemHandler_1_16_R1(JavaPlugin plugin) {
        super(plugin);
    }
    ...
    public ItemStack fromNBT(String string) {
        try {
            ...
            net.minecraft.server.v1_16_R1.ItemStack nmsItem = net.minecraft.server.v1_16_R1.ItemStack.a(nbtData);
