...
public final class ItemHandler_1_21_R7 extends ItemHandler {
    public ItemHandler_1_21_R7(@NotNull JavaPlugin plugin) {
        super(plugin);
    }
    ...
    public @NotNull String toNBT(@NotNull ItemStack item) {
        ...
        ProblemReporter problemReporter = new ProblemReporter_1_21_R7(plugin);
