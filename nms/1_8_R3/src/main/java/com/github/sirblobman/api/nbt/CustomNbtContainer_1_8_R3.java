...
public final class CustomNbtContainer_1_8_R3 implements CustomNbtContainer {
    ...
    public CustomNbtContainer_1_8_R3(Map<String, NBTBase> customTags, CustomNbtTypeRegistry_1_8_R3 registry) {
        this(registry);
        this.customDataTags.putAll(customTags);
    }

    public CustomNbtContainer_1_8_R3(CustomNbtTypeRegistry_1_8_R3 registry) {
    ...
    public CustomNbtTypeRegistry_1_8_R3 getDataTagTypeRegistry() {
