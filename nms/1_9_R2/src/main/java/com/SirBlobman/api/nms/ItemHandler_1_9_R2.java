...
public class ItemHandler_1_9_R2 extends ItemHandler {
    ...
    public String getKeyString(ItemStack item) {
        ...
        net.minecraft.server.v1_9_R2.ItemStack nmsItemStack = CraftItemStack.asNMSCopy(item);
    ...
    public ItemStack fromNBT(String string) {
        try {
            ...
            net.minecraft.server.v1_9_R2.ItemStack nmsItem = net.minecraft.server.v1_9_R2.ItemStack.createStack(nbtData);
