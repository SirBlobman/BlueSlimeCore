...
public final class CustomNbtContainer_1_9_R2 implements CustomNbtContainer {
    private final Map<String, NBTBase> customDataTags;
    private final CustomNbtTypeRegistry_1_9_R2 registry;
    private final CustomNbtContext_1_9_R2 adapterContext;

    public CustomNbtContainer_1_9_R2(Map<String, NBTBase> customTags, CustomNbtTypeRegistry_1_9_R2 registry) {
        this(registry);
        this.customDataTags.putAll(customTags);
    }

    public CustomNbtContainer_1_9_R2(CustomNbtTypeRegistry_1_9_R2 registry) {
        this.customDataTags = new HashMap<>();
        this.registry = registry;
        this.adapterContext = new CustomNbtContext_1_9_R2(this.registry);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CustomNbtContainer_1_9_R2)) {
            return false;
        } else {
            Map<String, NBTBase> myRawMap = this.getRaw();
            Map<String, NBTBase> theirRawMap = ((CustomNbtContainer_1_9_R2) obj).getRaw();
    ...
    public CustomNbtTypeRegistry_1_9_R2 getDataTagTypeRegistry() {
