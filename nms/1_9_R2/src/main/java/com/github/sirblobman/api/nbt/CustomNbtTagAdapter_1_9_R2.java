...
public final class CustomNbtTagAdapter_1_9_R2<T, Z extends NBTBase> {
    private final Function<T, Z> builder;
    private final Function<Z, T> extractor;
    private final Class<T> primitiveType;
    private final Class<Z> nbtBaseType;

    public CustomNbtTagAdapter_1_9_R2(Class<T> primitiveType, Class<Z> nbtBaseType, Function<T, Z> builder,
