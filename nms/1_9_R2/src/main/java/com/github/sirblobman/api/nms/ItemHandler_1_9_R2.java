...
public class ItemHandler_1_9_R2 extends ItemHandler {
    private final CustomNbtTypeRegistry_1_9_R2 nbtRegistry;

    public ItemHandler_1_9_R2(JavaPlugin plugin) {
        super(plugin);
        this.nbtRegistry = new CustomNbtTypeRegistry_1_9_R2();
    }
    ...
    public CustomNbtContainer createNewCustomNbtContainer() {
        return new CustomNbtContainer_1_9_R2(this.nbtRegistry);
    }
