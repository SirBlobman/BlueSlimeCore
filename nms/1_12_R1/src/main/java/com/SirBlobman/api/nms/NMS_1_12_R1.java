...
public class NMS_1_12_R1 extends NMS_Handler {
    ...
    private final BossBarHandler bossBarHandler = new BossBarHandler_1_12_R1();
    private final ScoreboardHandler scoreboardHandler = new ScoreboardHandler_1_12_R1();
