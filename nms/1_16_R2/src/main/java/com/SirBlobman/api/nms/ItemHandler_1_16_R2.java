...
public class ItemHandler_1_16_R2 extends ItemHandler {
    public ItemHandler_1_16_R2(JavaPlugin plugin) {
        super(plugin);
    }
    ...
    public ItemStack fromNBT(String string) {
        try {
            ...
            net.minecraft.server.v1_16_R2.ItemStack nmsItem = net.minecraft.server.v1_16_R2.ItemStack.a(nbtData);
