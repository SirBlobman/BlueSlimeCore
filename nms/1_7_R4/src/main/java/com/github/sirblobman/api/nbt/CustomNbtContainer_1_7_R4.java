...
public final class CustomNbtContainer_1_7_R4 implements CustomNbtContainer {
    ...
    public CustomNbtContainer_1_7_R4(Map<String, NBTBase> customTags, CustomNbtTypeRegistry_1_7_R4 registry) {
        this(registry);
        this.customDataTags.putAll(customTags);
    }

    public CustomNbtContainer_1_7_R4(CustomNbtTypeRegistry_1_7_R4 registry) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CustomNbtContainer_1_7_R4)) {
            ...
            Map<String, NBTBase> theirRawMap = ((CustomNbtContainer_1_7_R4) obj).getRaw();
