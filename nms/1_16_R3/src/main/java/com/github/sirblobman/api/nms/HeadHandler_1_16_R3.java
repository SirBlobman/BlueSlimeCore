...
public final class HeadHandler_1_16_R3 extends HeadHandler {
    public HeadHandler_1_16_R3(@NotNull JavaPlugin plugin) {
        super(plugin);
    }
    ...
    private void setGameProfile(@NotNull SkullMeta meta, @NotNull GameProfile profile) {
        try {
            Class<?> metaClass = Class.forName("org.bukkit.craftbukkit.v1_16_R3.inventory.CraftMetaSkull");
