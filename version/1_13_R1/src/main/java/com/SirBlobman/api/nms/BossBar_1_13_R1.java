...
public class BossBar_1_13_R1 extends BossBar {
	private static final Map<UUID, org.bukkit.boss.BossBar> BOSS_BARS = new HashMap<>();
	public BossBar_1_13_R1(Player player, String title, double progress, String barColor, String barStyle) {super(player, title, progress, barColor, barStyle);}
